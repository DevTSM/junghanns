      ...
      if (await locationInstance.serviceEnabled()) {
        ...
        await setInitRoute(
          ...
          if (answer.error) {
            ...
            prefs.statusRoute == "inicio_comida" ? "INCM" : "FNRT";
            Fluttertoast.showToast(
...
Widget drawer(ProviderJunghanns provider, BuildContext context,Function setIndexCurrent) {
    ...
    return Builder(
      ...
      children: [
       Image.asset(
        ...
        Text(title,style: TextStyles.blue16_4,)
      ],
    ),
    const Divider(color: ColorsJunghanns.lighGrey,height: 18,thickness: 2,)
    ])));
  }
  return Drawer(
      child: Container(
          ...
          MaterialPageRoute<void>(
              builder: (BuildContext context) => const Call())),"assets/icons/menuOp5B.png","Llamadas"),
              item((){},"assets/icons/menuOp4B.png","Atendidos")
                          ],
                        ),
                      )),
                      Visibility(
                                  ...
                                  child: Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          AutoSizeText(
                                            prefs.statusRoute == "FNCM"?"Finalizar ruta":"Fin",
