class FolioModel{
  ...
  factory FolioModel.fromDataBase(Map<String,dynamic> data,String serie){
    return FolioModel(id:data["id"], status: data["status"],number: data["numero"], serie: serie, type: data["tipo"]);
  }
  getMap(){
    return {
      "status":status,
