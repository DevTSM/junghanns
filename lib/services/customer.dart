...
Future<Answer> getListCustomer()async {
  ...
  try{
  var response= jsonDecode((await http.get(Uri.parse("$urlBase/index.php/visita?idRuta=10&date=20220617&tipo=R"), headers: {
...
Future<Answer> getDetailsCustomer(int id)async {
  ...
  try{
  var response= jsonDecode((await http.get(Uri.parse("$urlBase/index.php/cliente?q=dashboard&tipo=R&id=$id"), headers: {
      "Content-Type": "aplication/json",
      "x-api-key":apiKey,
      "client_secret":clientSecret,
      "Authorization": "Bearer " + "caf048dc9e6560d05fe75f8d00ee4c48db607654",
