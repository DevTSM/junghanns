...
Future<Answer> getPaymentMethods(int idClient)async {
  ...
  try{
  var response= jsonDecode((await http.get(Uri.parse("$urlBase/index.php/cliente?q=pay&idRuta=22&idCliente=$idClient"), headers: {
      "Content-Type": "aplication/json",
      "x-api-key":apiKey,
      "client_secret":clientSecret,
      "Authorization": "Bearer " + "caf048dc9e6560d05fe75f8d00ee4c48db607654",
...
Future<Answer> getAuthorization(int idClient)async {
  ...
  try{
  var response= jsonDecode((await http.get(Uri.parse("$urlBase/index.php/cliente?q=aut&idRuta=21&idCliente=$idClient"), headers: {
      "Content-Type": "aplication/json",
      "x-api-key":apiKey,
      "client_secret":clientSecret,
      "Authorization": "Bearer " + "caf048dc9e6560d05fe75f8d00ee4c48db607654",
...
Future<Answer> getFolio(String num)async {
  ...
  try{
  var response= jsonDecode((await http.get(Uri.parse("$urlBase/index.php/validate?q=folio&num=$num"), headers: {
      "Content-Type": "aplication/json",
      "x-api-key":apiKey,
      "client_secret":clientSecret,
      "Authorization": "Bearer " + "caf048dc9e6560d05fe75f8d00ee4c48db607654",
...
Future<Answer> setSale(Map<String,dynamic> data)async {
  ...
  try{
  var response= jsonDecode((await http.post(Uri.parse("$urlBase/index.php/cliente"), headers: {
      "Content-Type": "aplication/json",
      "x-api-key":apiKey,
      "client_secret":clientSecret,
      "Authorization": "Bearer " + "caf048dc9e6560d05fe75f8d00ee4c48db607654",
