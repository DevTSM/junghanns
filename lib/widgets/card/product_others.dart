...
class ProductMissingCardState extends State<ProductOthersCard> {
  late Size size;
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                if (widget.product.idProduct != 22 && widget.product.idProduct != 21 && widget.product.idProduct != 136 && widget.product.idProduct != 125 && widget.product.idProduct != 50) ...[
                                  IconButton(
