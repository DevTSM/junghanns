...
class DeleteReception extends StatefulWidget {
  final Function(String) onReject;

  DeleteReception({required this.onReject, super.key});

  @override
  State<StatefulWidget> createState() => _DeleteReceptionState();
}

class _DeleteReceptionState extends State<DeleteReception> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 5),
            _sufixLabel("Ingresa un motivo o describe brevemente la razón por la cual elimina la recepción"),
            _textField(),
            Visibility(
                visible: error != '',
                child: Text(
...
void showDeleteReception({required BuildContext context, required Function(String) onReject}) {
  showDialog(
    context: context,
    ...
    builder: (_) => AlertDialog(
        ...
        content: DeleteReception(onReject: onReject)),
  );
}
