...
class SelectProductOthers extends StatelessWidget {
  final ProductModel current;
  final Function(ProductModel? newValue) update;

  const SelectProductOthers({super.key, required this.current, required this.update});
            ...
            child: Container(
              child: DropdownButton<ProductModel?>(
                ...
                items: controller.stockProducts
                    .where((item) => item.stock > 0 && ![21, 22, 50, 125, 136].contains(item.idProduct))
